...
namespace HelLanhShop.Infrastructure.Migrations
{
    ...
    public partial class InitDatabase : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "ComboTemplateItems",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ComboTemplateId = table.Column<int>(type: "int", nullable: false),
                    ProductId = table.Column<int>(type: "int", nullable: false),
                    WeightGram = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ComboTemplateItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ComboTemplateItems_ComboTemplates_ComboTemplateId",
                        column: x => x.ComboTemplateId,
                        principalTable: "ComboTemplates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ComboTemplateItems_Products_ProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InventoryEntries_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ComboTemplateItems_ComboTemplateId",
                table: "ComboTemplateItems",
                column: "ComboTemplateId");

            migrationBuilder.CreateIndex(
                name: "IX_ComboTemplateItems_ProductId",
                table: "ComboTemplateItems",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_InventoryEntries_EmployeeId",
